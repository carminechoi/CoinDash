				...
				<TableBody>
					{coins.map((coin) => (
						...
						>
							...
							<PercentageTableCell percent={coin.priceChangePercentage1h}>
								{coin.priceChangePercentage1h}%
							</PercentageTableCell>
							<PercentageTableCell percent={coin.priceChangePercentage24h}>
								{coin.priceChangePercentage24h}%
							</PercentageTableCell>
							<PercentageTableCell percent={coin.priceChangePercentage7d}>
								{coin.priceChangePercentage7d}%
							</PercentageTableCell>

							<TableCell align="right">{coin.volume24h}</TableCell>
							<TableCell align="right">{coin.marketCap}</TableCell>
							<TableCell align="right">{coin.circulatingSupply}</TableCell>
						</TableRow>
					))}
				</TableBody>
			</Table>
